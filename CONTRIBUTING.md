...
Thank you for your interest in `proxy-example`, an open source project
administered by StrongLoop.

Contributing to `proxy-example` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-example-proxy)
